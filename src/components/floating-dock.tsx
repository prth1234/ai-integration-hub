...
export const FloatingDockDemo = () => {
  const links = [
    ...
    {
      title: "Changelog",
      icon: <GitBranch className="h-full w-full text-neutral-500 dark:text-neutral-300" />,
      href: "#",
    },
    {
      title: "Twitter",
  ...
  return (
    <div className="flex items-center justify-center h-[35rem] w-full bg-white dark:bg-black">
      <FloatingDock
        items={links}
